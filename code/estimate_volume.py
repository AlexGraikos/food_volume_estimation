...
from segmentation.mask_rcnn_segmentation import FoodSegmentator
        ...
        for k in range(masks_array.shape[-1]):
            ...
            if plot_results:
                ...
                object_points_df = pd.DataFrame(
                    np.concatenate((object_points, object_colors_flat), 
                ...
                estimated_volumes.append(
                    (estimated_volume, object_points_df, all_points_df,
